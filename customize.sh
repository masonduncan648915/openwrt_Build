...
git clone https://github.com/masonduncan648915/openwrt-packages.git package/openwrt-packages
git clone https://github.com/masonduncan648915/small.git package/openwrt-packages
